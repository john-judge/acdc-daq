...
//Edit by Miles Lucas - This is what I think a great method comment looks like
/*
 * Checks the number of active ACDC boards connected to central card
 *
 * @param print
 *      determines verbosity of Method
 * @return
 *      number of active ACDC boards
 */
